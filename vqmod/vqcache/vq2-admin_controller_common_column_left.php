	...
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'localisation/payconfirm_destination')) {
				$payconfirm[] = array(
					'name'	   => $this->language->get('text_payconfirm_destination'),
					'href'     => $this->url->link('localisation/payconfirm_destination', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			
			if ($this->user->hasPermission('access', 'localisation/payconfirm_method')) {
				$payconfirm[] = array(
					'name'	   => $this->language->get('text_payconfirm_method'),
					'href'     => $this->url->link('localisation/payconfirm_method', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);		
			}
			...
			if ($this->user->hasPermission('access', 'localisation/payselect')) {
				$payconfirm[] = array(
					...
					'href'     => $this->url->link('localisation/payselect', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);		
			}
