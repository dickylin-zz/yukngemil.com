      ...
      <nav id="top">
        <div class="container">
          ...
          <div id="top-links" class="nav pull-right">
			...
			<li><a href="<?php echo $payconfirm; ?>" title="<?php echo $text_payconfirm; ?>" class="agree"><i class="fa fa-info"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_payconfirm; ?></span></a></li>
