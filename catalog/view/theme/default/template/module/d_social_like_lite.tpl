...
$(document).ready(function(){
  $('#d_social_like.inline').delay(400).slideDown('slow');
  $('#d_social_like.left').delay(400).animate({left:'0px', easing: 'easeInOutQuint'}, 400);
  $('#d_social_like.right').delay(400).animate({right:'0px', easing: 'easeInOutQuint'}, 400);
  $('#d_social_like.top').delay(400).animate({top:'0px', easing: 'easeInOutQuint'}, 400)
  						 .parents('html').delay(400).animate({"margin-top":'39px', easing: 'easeInOutQuint'}, 400);
  $('#d_social_like.bottom').delay(400).animate({bottom:'0px', easing: 'easeInOutQuint'}, 400)
  						 .parents('html').delay(400).animate({"margin-bottom":'39px', easing: 'easeInOutQuint'}, 400);
}); 
