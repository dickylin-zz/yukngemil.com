...
//facebook fix
        ...
        if(VERSION >= '2.2.0.0'){
            return $this->load->view('module/d_social_login', $data);
        }elseif (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/d_social_login.tpl')) {
    ...
    public function login() {
        ...
        $this->setting['base_url'] = $this->config->get('config_secure') ? $httpsServer . 'd_social_login.php' : $httpServer . 'd_social_login.php';
        ...
        if ($this->setting['provider'] == 'Facebook') {
            $this->setting['base_url'] = $httpServer . 'd_social_login.php';
        }

        if ($this->setting['provider'] == 'Live') {
            $this->setting['base_url'] = $this->config->get('config_secure') ? $httpsServer . 'd_social_login_live.php' : $httpServer . 'd_social_login_live.php';
        }
